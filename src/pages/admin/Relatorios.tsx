              ...
              >
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div className={`p-2 sm:p-3 rounded-lg ${report.bgColor}`}>
                      <IconComponent className={`h-5 w-5 sm:h-6 sm:w-6 ${report.color}`} />
                    </div>
                    <Badge className={`${getPriorityColor(report.priority)} text-xs`}>
                      {report.priority}
                    </Badge>
                  </div>
                  <CardTitle className="text-lg sm:text-xl mt-2">{report.title}</CardTitle>
                </CardHeader>
                <CardContent>
